//! ARP request parsing and reply construction for fabric frames.

use std::net::Ipv4Addr;

use super::{ETH_HDR_LEN, ETHERTYPE_ARP, ETHERTYPE_IPV4, VNET_HDR_SZ};
...
pub fn parse_arp_request(frame: &[u8]) -> Option<(Ipv4Addr, [u8; 6], Ipv4Addr)> {
    ...
    if hw_type != 1 || proto_type != ETHERTYPE_IPV4 || op != 1 {
        return None;
    }
