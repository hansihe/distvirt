use super::*;
use crate::sm_new::{
    LeaseInfo, Router, ServiceSm, ServiceSpec, WorkerInfo, WorkloadId,
...
fn setup_workload(router: &mut Router) -> (WorkerId, PodId) {
...
fn schedule_pod(router: &mut Router, worker: WorkerId, pod_id: PodId) {
