---
title: "Protocol Activators"
---

> **Status (March 2026):** ~90% implemented. Core activator pipeline works. Note: `tcp_only` field is defined but unused; Postgres is not yet wirable via config.
